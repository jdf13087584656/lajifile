...
public class DateUtil {
    ...
    /**
     * 获取当前系统时间字符串：yyyy/MM/dd HH:mm:ss
     */
    ...
    public static String getStringNowDateTwo() {
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String dateString = formatter.format(new Date());
        return dateString;
    }
    /**
     * 将yyyy-MM-dd HH:mm:ss此类型的字符串时间转换为yyyy/MM/dd HH:mm:ss此类型字符串
     */
    public static String convertTimeFormat(String stringDate) {
    ...
    /**
     * 将yyyy-MM-dd HH:mm:ss此类型的字符串时间转换为yyyy/MM/dd 此类型字符串
     */
    public static String convertTimeFormaty(String stringDate) {
        String resultDate = null;
        try {
            Date date = (new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).parse(stringDate);
    ...
    public static Date parseDate(String dateStr) {
        ...
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try {
            dateResult = formatter.parse(dateStr);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return dateResult;
